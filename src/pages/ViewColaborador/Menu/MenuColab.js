...
/* eslint-disable prettier/prettier */
/* Tela de Menu do Colaborador */

import React from 'react';
import {ImageBackground, View, StyleSheet, StatusBar, ActivityIndicator, RefreshControl, ScrollView} from 'react-native';
import {Button, Text, Header, Right, Body} from 'native-base';
import {Icon} from 'react-native-elements';

export class MenuColab extends React.Component {
  constructor (props){
    super(props);
    this.state = {
      loading: true,
